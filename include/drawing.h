...
struct Point
    : private boost::equality_comparable<
          ...
          boost::addable<
              ...
              boost::subtractable<
                  Point,
                  boost::multipliable<Point, boost::dividable<Point>>>>> {
...
struct Size : private boost::equality_comparable<
                  Size,
                  boost::addable<
                      Size,
                      boost::subtractable<
                          Size,
                          boost::multipliable<Size, boost::dividable<Size>>>>> {
    Size() = default;
...
constexpr Color color_red(Uint8 amount = 255, Uint8 alpha = 255) noexcept {
    return {amount, 0, 0, alpha};
}

constexpr Color color_green(Uint8 amount = 255, Uint8 alpha = 255) noexcept {
    return {0, amount, 0, alpha};
}

constexpr Color color_blue(Uint8 amount = 255, Uint8 alpha = 255) noexcept {
    return {0, 0, amount, alpha};
}

constexpr Color color_yellow(Uint8 amount = 255, Uint8 alpha = 255) noexcept {
    return {amount, amount, 0, alpha};
}

constexpr Color color_black(Uint8 alpha = 255) noexcept {
    return {0, 0, 0, alpha};
}

constexpr Color color_white(Uint8 alpha = 255) noexcept {
...
struct Angle_rad {  // Angle in radians
    ...
    explicit Angle_rad(double) noexcept;
    double value;
};
...
class Window {
   ...
   private:
    ...
    static Unique_window create_checked_window(
        const Window_properties&,
        Uint32);
    static Unique_window create_unchecked_window(
        const Window_properties&,
        Uint32);
